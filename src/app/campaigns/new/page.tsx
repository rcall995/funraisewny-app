...
// We import the standard Next.js types to ensure the type environment is correctly initialized.
// This is an external type definition trick to stabilize PageProps.
import type { Metadata, ResolvingMetadata, NextPage } from 'next'; 

// The component is now typed using the standard NextPage interface pattern,
// making it more compatible with the Next.js build constraints.
const EditCampaignPage: NextPage<{ params: { id: string } }> = ({ params }) => {
...
export default EditCampaignPage; // Export the typed component
